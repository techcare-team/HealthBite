...
class CVClearEdit : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        clearButtonImage = ContextCompat.getDrawable(context, R.drawable.logo_failed) as Drawable
        iconFormInput = ContextCompat.getDrawable(context, R.drawable.logo_person) as Drawable
